...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Missy" },
      { name: "description", content: "A modern point-of-sale and inventory management system for car accessory shops." },
      { property: "og:title", content: "Missy" },
      { name: "twitter:title", content: "Missy" },
      { property: "og:description", content: "A modern point-of-sale and inventory management system for car accessory shops." },
      { name: "twitter:description", content: "A modern point-of-sale and inventory management system for car accessory shops." },
